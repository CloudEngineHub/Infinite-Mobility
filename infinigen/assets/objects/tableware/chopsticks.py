...
class ChopsticksFactory(TablewareFactory):
    ...
    def create_asset(self, **params) -> bpy.types.Object:
        ...
        if uniform(0, 1) < 0.6:
            obj = self.make_parallel(obj, params.get("path", None), params.get("i", "unknown"))
        else:
            obj = self.make_crossed(obj, params.get("path", None), params.get("i", "unknown"))
        return obj

    def make_parallel(self, obj, path=None, i="unknown"):
        ...
        return save_obj_parts_join_objects([obj, other], path, i, name="chopsticks_part", obj_name="Chopsticks")

    def make_crossed(self, obj, path=None, i="unknown"):
        other = deep_clone_obj(obj)
