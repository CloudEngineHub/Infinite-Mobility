...
from infinigen.assets.objects.tables.table_top import nodegroup_capped_cylinder, nodegroup_seat_cylinder
...
def generate_round_seats(
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput,
        input_kwargs={"Geometry": cappedcylinder},
