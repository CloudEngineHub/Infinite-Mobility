...
class BathroomSinkFactory(BathtubFactory):
    ...
    def create_asset(self, **params) -> bpy.types.Object:
        ...
        if self.has_stand:
            self.add_stand(obj, params.get("path", None), params.get("i", "unknown"))
    ...
    def add_stand(self, obj, path=None, i="unknown"):
        ...
        subsurf(stand, 1)
        save_obj_parts_add([stand], path, i, name=["stand"])
