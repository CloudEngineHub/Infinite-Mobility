...
def nodegroup_side_boards(nw: NodeWrangler):
    ...
    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [cube_1_store, cube_2_store]}
    )
...
def nodegroup_shelf_boards(nw: NodeWrangler):
    ...
    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry,
        input_kwargs={"Geometry": [cube_store_1, cube_store_2, cube_store_3]},
    )
...
def nodegroup_shelf_legs(nw: NodeWrangler):
    ...
    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry,
        input_kwargs={"Geometry": [cube_1_store, cube_2_store, cube_3_store]},
    )
    ...
    for i, name in enumerate(names):
        ...
        for j in range(1, parts[i]+1):
            ...
            separate_geometry = nw.new_node(
                ...
                input_kwargs={
                    "Geometry": transform5.outputs["Geometry"],
