...
def nodegroup_screw_head(nw: NodeWrangler):
    ...
    join_geometry_3 = nw.new_node(
        Nodes.JoinGeometry,
        input_kwargs={"Geometry": [
            store_screw_head_1.outputs["Geometry"],
            store_screw_head_2.outputs["Geometry"], 
            store_screw_head_3.outputs["Geometry"], 
            store_screw_head_4.outputs["Geometry"], 
        ]},
    )
    # TODO
...
def nodegroup_base_frame(nw: NodeWrangler):
    ...
    # Store unique 'cube' for Cube 1
    store_base_frame_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_2,  # Geometry with UV map
            "Name": "base_frame",
    ...
    # Store unique 'cube' for Cube 1
    store_base_frame_2 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_3,  # Geometry with UV map
            "Name": "base_frame",
    ...
    # Store unique 'cube' for Cube 1
    store_base_frame_3 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_4,  # Geometry with UV map
            "Name": "base_frame",
    ...
    # Store unique 'cube' for Cube 1
    store_base_frame_4 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_5,  # Geometry with UV map
            "Name": "base_frame",
    ...
    # Store unique 'cube' for Cube 1
    store_base_frame_5 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
    ...
    # Store unique 'cube' for Cube 1
    store_base_frame_6 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_7,  # Geometry with UV map
            "Name": "base_frame",
            "Value": 6,  # Assign Cube 1 an ID of 1
        },
        attrs={"domain": "POINT", "data_type": "INT"},
    )

    # Store unique 'cube' for Cube 1
    store_base_frame_7 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_8,  # Geometry with UV map
            "Name": "base_frame",
            "Value": 7,  # Assign Cube 1 an ID of 1
        },
        attrs={"domain": "POINT", "data_type": "INT"},
    )

    # Store unique 'cube' for Cube 1
    store_base_frame_8 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_9,  # Geometry with UV map
            "Name": "base_frame",
            "Value": 8,  # Assign Cube 1 an ID of 1
        },
        attrs={"domain": "POINT", "data_type": "INT"},
    )
    ...
    join_geometry_3 = nw.new_node(
        ...
        input_kwargs={
            "Geometry": [
                store_base_frame_1.outputs["Geometry"],
                store_base_frame_2.outputs["Geometry"],
                store_base_frame_3.outputs["Geometry"],
                store_base_frame_4.outputs["Geometry"],
                store_base_frame_5.outputs["Geometry"],
                store_base_frame_6.outputs["Geometry"],
                store_base_frame_7.outputs["Geometry"],
                store_base_frame_8.outputs["Geometry"],
            ]
        },
    )
    # TODO
...
def nodegroup_attach_gadget(nw: NodeWrangler):
    ...
    # TODO
    # Store unique 'attach_gadget' for Cube 1
    store_attach_gadget = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": cube,  # Geometry with UV map
            "Name": "attach_gadget",
    ...
    transform_6 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_attach_gadget.outputs["Geometry"], "Translation": combine_xyz_5}
    )
    # TODO
    ...
    # TODO
    # Store unique 'cube' for Cube 1
    store_attach_gadget_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": cube,  # Geometry with UV map
            "Name": "attach_gadget",
    ...
    transform_7 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_attach_gadget_1.outputs["Geometry"], "Translation": combine_xyz_6}
    )
    # TODO
...
def nodegroup_top_bottom_board(nw: NodeWrangler, tag_support=False):
    ...
    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [store_cube_2.outputs["Geometry"], store_cube.outputs["Geometry"]]}
    )
    # TODO
...
def nodegroup_side_board(nw: NodeWrangler):
    ...
    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [store_cube.outputs["Geometry"], store_cube_1.outputs["Geometry"]]}
    )
        # TODO
...
def geometry_nodes(nw: NodeWrangler, **kwargs):
    ...
    for i in range(1, kwargs["horizontal_cell_num"]):
        ...
        # TODO
        # Store unique 'v_division_boards' for Cube 1
        store_v_division_boards_1 = nw.new_node(
            Nodes.StoreNamedAttribute,
            input_kwargs={
                "Geometry": transform_1,  # Geometry with UV map
                "Name": "v_division_boards",
                "Value": i,  # Assign Cube 1 an ID of 1
            },
            attrs={"domain": "POINT", "data_type": "INT"},
        )
        v_division_boards.append(store_v_division_boards_1.outputs["Geometry"])
        # TODO
    ...
    # TODO
        ...
        store_h_division_boards_1 = nw.new_node(
            Nodes.StoreNamedAttribute,
            input_kwargs={
                "Geometry": transform,  # Geometry with UV map
                "Name": "h_division_boards",
                "Value": j,  # Assign Cube 1 an ID of 1
            },
            attrs={"domain": "POINT", "data_type": "INT"},
        )
        h_division_boards.append(store_h_division_boards_1.outputs["Geometry"])
    # TODO
    ...
    # TODO
    names = ["side_board", "top_bottom_board", "v_division_boards", "h_division_boards"]
    parts = [2, 2, kwargs["horizontal_cell_num"] - 1, kwargs["vertical_cell_num"] - 1]
    # TODO
