...
@node_utils.to_nodegroup(
    "nodegroup_seat_cylinder", singleton=False, type="GeometryNodeTree"
)
def nodegroup_seat_cylinder(nw: NodeWrangler):
    # Code generated using version 2.6.4 of the node_transpiler
    ...
    generatetabletop = nw.new_node(
        nodegroup_generate_table_top_v2().name,
        input_kwargs={
            "Thickness": multiply,
            "N-gon": group_input.outputs["Resolution"],
            "Profile Width": multiply_2,
...
@node_utils.to_nodegroup(
    "nodegroup_wheel_cylinder", singleton=False, type="GeometryNodeTree"
)
def nodegroup_wheel_cylinder(nw: NodeWrangler):
    # Code generated using version 2.6.4 of the node_transpiler
    ...
    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [generatetabletop]}
    )
...
@node_utils.to_nodegroup(
    "nodegroup_generate_table_top_v2", singleton=False, type="GeometryNodeTree"
)
def nodegroup_generate_table_top_v2(nw: NodeWrangler):
    # Code generated using version 2.6.4 of the node_transpiler
    ...
    compare_less = nw.new_node(
        Nodes.Compare,
        input_kwargs={0: separate_xyz.outputs["Z"], 1: -0.001},
    ...
    separate_geometry = nw.new_node(
        ...
        input_kwargs={
            "Geometry": cap,
            "Selection": compare_less.outputs["Result"],
        },
    )

    store_seat_1 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
    ...
    store_seat_2 = nw.new_node(
        Nodes.StoreNamedAttribute,
        input_kwargs={
            "Geometry": transform_5,
            "Name": "seat",
            "Value": 2,
        },
        attrs={"domain": "POINT", "data_type": "INT"},
    ...
    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [store_seat_1, store_seat_2]}
    )
