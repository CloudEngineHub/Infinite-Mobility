...
def shader_cobblestone(nw: NodeWrangler, random_seed=0):
    # Code generated using version 2.4.3 of the node_transpiler, and modified# input_kwargs["Vector"] = self.new_node(Nodes.InputPosition)?
    ...
    principled_bsdf = nw.new_node(
        Nodes.PrincipledBSDF,  # BSDF - Bidirectional scattering distribution function
...
def geo_cobblestone(nw: NodeWrangler, selection=None, random_seed=0, geometry=True):
    ...
    with FixedSeed(random_seed):
        ...
        voronoi_texture_3 = nw.new_node(
            ...
            input_kwargs={
                "Vector": position,
                "W": nw.new_value(U(-5, 5), "W4"),  # TODO: What is W?
                "Scale": multiply,
                "Randomness": uni_sto,
            },
            attrs={"voronoi_dimensions": "4D", "feature": "DISTANCE_TO_EDGE"},
